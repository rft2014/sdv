...
public class MakeIliasUserInsertFile extends JFrame{
	...
	private void createFile(String filename){
		...
		try {
			...
			String fuerIlias = "SELECT * FROM schuelerdaten WHERE term = '1' AND (klasse ='5a' OR klasse ='5b')";
			...
			try
		{
		   ...
		   while (rs.next()){
			...
			//String Login_M = makeLoginName(rs.getString("mvorname"), rs.getString("mname"), 1);
		    ...
		    brief.write(SerienbriefIliasAnmeldungen.Brieftext_3);
